...
bool cooldown,nomana;
void (*old_cooldown)(void *instance,float value);
bool (*old_nomana)(void *instance,void *status);

void get_cooldown(void *instance,float value){
    if(instance != NULL){
        if(cooldown){
            value = 0.0f;
            return old_cooldown(instance,value);
        }
    }
    return old_cooldown(instance,value);
}

bool get_nomana(void *instance,void *status){
    if(instance != NULL){
        if(nomana){
            return true;
        }
    }
    return old_nomana(instance,status);
}
...
void *hack_thread(void *) {
    ...
    HOOK_LIB("libil2cpp.so", "0x2FE8248", get_cooldown, old_cooldown);
    HOOK_LIB("libil2cpp.so", "0x2F59CBC", get_nomana, old_nomana);
...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("Toggle_No Cooldown"),
            OBFUSCATE("Toggle_No Mana Cost")
            /*
